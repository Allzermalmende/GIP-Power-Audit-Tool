      ...
      : React.createElement('div', null,
          ...
          React.createElement('table', { border:1, cellPadding:5 },
            ...
            React.createElement('tbody', null, rows.map((r,i)=>React.createElement('tr',{key:i},
              ...
              React.createElement('td', null, React.createElement('input',{value:r.loc,onChange:e=>updateRow(i,'loc',e.target.value), disabled: r.info !== "Previous information doesn't match"})),
